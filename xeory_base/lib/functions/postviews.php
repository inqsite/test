...
class WP_Widget_PostViews_bzb extends WP_Widget {
  ...
  function WP_Widget_PostViews_bzb() {
    ...
    $this->WP_Widget('views', __('ページビュー数', 'wp-postviews'), $widget_ops);
  }
  ...
  function widget($args, $instance) {
    ...
    switch($type) {
      ...
      case 'most_viewed_category':
        bzb_get_most_viewed_category($cat_ids, $mode, $limit, $chars);
        break;
    }
    echo '</ul>'."\n";
    echo $after_widget;
...
?>
    <p>
      <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('タイトル:', 'wp-postviews'); ?> <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></label>
    </p>
    <input type="hidden" name="<?php echo $this->get_field_name('type'); ?>" value="most_viewed">
    <p>
      <label for="<?php echo $this->get_field_id('mode'); ?>"><?php _e('ページビューをカウントするページ:', 'wp-postviews'); ?>
        <select name="<?php echo $this->get_field_name('mode'); ?>" id="<?php echo $this->get_field_id('mode'); ?>" class="widefat">
          <option value="both"<?php selected('both', $mode); ?>><?php _e('投稿ページと固定ページ', 'wp-postviews'); ?></option>
          <option value="post"<?php selected('post', $mode); ?>><?php _e('投稿ページのみ', 'wp-postviews'); ?></option>
          <option value="page"<?php selected('page', $mode); ?>><?php _e('固定ページのみ', 'wp-postviews'); ?></option>
        </select>
      </label>
    </p>
    <p>
      <label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('表示件数:', 'wp-postviews'); ?> <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" /></label>
    </p>
    <p>
      <label for="<?php echo $this->get_field_id('chars'); ?>"><?php _e('タイトルの最大文字数:', 'wp-postviews'); ?> <input class="widefat" id="<?php echo $this->get_field_id('chars'); ?>" name="<?php echo $this->get_field_name('chars'); ?>" type="text" value="<?php echo $chars; ?>" /></label><br />
      <small><?php _e('<strong>0</strong> to disable.', 'wp-postviews'); ?></small>
    </p>
    <p>
      <label for="<?php echo $this->get_field_id('cat_ids'); ?>"><?php _e('表示したいカテゴリーID:', 'wp-postviews'); ?> <span style="color: red;">*</span> <input class="widefat" id="<?php echo $this->get_field_id('cat_ids'); ?>" name="<?php echo $this->get_field_name('cat_ids'); ?>" type="text" value="<?php echo $cat_ids; ?>" /></label><br />
      <small><?php _e('複数ある場合はカンマで区切って入力', 'wp-postviews'); ?></small>
    </p>
    <p>
